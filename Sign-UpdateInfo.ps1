...
param(
    ...
    [string]$PrivateKeyFile = (Join-Path $PSScriptRoot 'private\KeeUnicodeURL-update-private.xml'),

    [Parameter(Mandatory = $false)]
    [string]$VersionInfoFile = (Join-Path $PSScriptRoot 'KeeUnicodeURL-version.txt')
)
